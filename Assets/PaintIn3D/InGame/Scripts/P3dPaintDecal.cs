...
namespace PaintIn3D
{
    ...
    public class P3dPaintDecal : MonoBehaviour, IHit, IHitPoint, IHitLine, IHitTriangle, IHitQuad, IHitCoord
    {
        ...
        public P3dModel TargetModel { set { targetModel = value; } get { return targetModel; } }
        [SerializeField] private P3dModel targetModel;

        /// <summary>Only the <b>P3dPaintableTexture</b> components with a matching group will be painted by this component.</summary>
        public P3dGroup Group { set { group = value; } get { return group; } }
        [SerializeField] private P3dGroup group;
        ...
        public P3dPaintableTexture TargetTexture { set { targetTexture = value; } get { return targetTexture; } }
        [SerializeField] private P3dPaintableTexture targetTexture;
        ...
        public P3dBlendMode BlendMode { set { blendMode = value; } get { return blendMode; } }
        [SerializeField] private P3dBlendMode blendMode = P3dBlendMode.AlphaBlend(Vector4.one);
        ...
        public P3dChannel ShapeChannel { set { shapeChannel = value; } get { return shapeChannel; } }
        [SerializeField] private P3dChannel shapeChannel = P3dChannel.Alpha;
        ...
        public float Hardness { set { hardness = value; } get { return hardness; } }
        [SerializeField] private float hardness = 3.0f;

        /// <summary>This allows you to control how much the decal can wrap around uneven paint surfaces.</summary>
        public float Wrapping { set { wrapping = value; } get { return wrapping; } }
        [SerializeField] [Range(0.0f, 1.0f)] private float wrapping = 1.0f;
        ...
        public float NormalFront { set { normalFront = value; } get { return normalFront; } }
        [Range(0.0f, 2.0f)] [SerializeField] private float normalFront = 1.0f;
        ...
        public float NormalBack { set { normalBack = value; } get { return normalBack; } }
        [Range(0.0f, 2.0f)] [SerializeField] private float normalBack;

        /// <summary>This allows you to control the smoothness of the normal cut-off point.</summary>
        public float NormalFade { set { normalFade = value; } get { return normalFade; } }
        [Range(0.001f, 0.5f)] [SerializeField] private float normalFade = 0.01f;
        ...
        public P3dModifierList Modifiers { get { if (modifiers == null) modifiers = new P3dModifierList(); return modifiers; } }
        [SerializeField] private P3dModifierList modifiers;



        public static P3dPaintDecal instance;
