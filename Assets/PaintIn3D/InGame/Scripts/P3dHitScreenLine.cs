...
namespace PaintIn3D
{
	...
	public class P3dHitScreenLine : P3dHitScreenBase
	{
		...
		protected override void HandleFingerUpdate(P3dInputManager.Finger finger)
		{
			...
			switch (frequency)
			{
				...
				case FrequencyType.Once: PaintOne(finger, position, pixelOffset); break;
			}
		...
		private void PaintOne(P3dInputManager.Finger finger, float frac, float pixelOff)
		{
			var preview = finger.Up == false;
			var pointS  = finger.StartScreenPosition;
			var pointE  = finger.ScreenPosition;
